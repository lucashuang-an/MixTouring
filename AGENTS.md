...
- **当前阶段（2026-09-23）**：旧产品 Phase 1–3、v1.2 的 G1/G2 已交付；G2.5 当前代码 v0.35.2、PR #10 十三轮产品评审「需修复」（单程仍保留返程窗口，见 Issue #5）。修复复审后，下一产品卡优先线路发现质量、推荐理由与取舍展示。**指定日期可执行往返比较、城市停留完整旅程与社区试点尚未实现**。北京 ⇄ 阿拉木图、2026 国庆附近为第一验证 case；外部证据缺口仍按探索／部分核验处理。
- 开发阶段路线与交接细节见 §6。
