...
- **当前阶段（2026-09-25）**：旧产品 Phase 1–3、v1.2 的 G1/G2 已交付；G2.5 统一入口与探索骨架、G2.6 线路发现首卡已收口（PR #10/#11 十四/十七轮评审通过合并，main=906ff96，v0.39.0）。下一产品卡＝G2.7 取舍展示与脆弱段备选方向。**指定日期可执行往返比较、城市停留完整旅程与社区试点尚未实现**。北京 ⇄ 阿拉木图、2026 国庆附近为第一验证 case；外部证据缺口仍按探索／部分核验处理。
- 开发阶段路线与交接细节见 §6。
